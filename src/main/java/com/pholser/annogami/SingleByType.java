...
/**
 * Contract for an object that can ask for a non-repeated annotation by its
 * type on a program element. Implementers decide what "on" means.
 */
public sealed interface SingleByType permits AbstractMeta, Direct, Present {
  /**
   * Gives a non-repeated annotation of the given type from the given program
   * element.
   *
