...
class SpringAliasForArrayValuedAttributeTest {
  ...
  void arrayValuePropagatesFromValueToBasePackages() {
    assertThat(DIRECT.find(ComponentScan.class, SetViaValue.class, spring()))
  ...
  void arrayValuePropagatesFromComposedToMetaAnnotation() {
    assertThat(META_DIRECT.find(Scan.class, SetViaValue.class, spring()))
  ...
  void twoSynthesizedAnnotationsWithSameArrayValueAreEqual() {
    ComponentScan cs1 =
      DIRECT.find(ComponentScan.class, SetViaValue.class, spring())
        .orElseThrow();
    ComponentScan cs2 =
      DIRECT.find(
        ComponentScan.class,
  ...
  void synthesizedAnnotationEqualsRealAnnotationWithSameValues() {
    ...
    assertThat(DIRECT.find(ComponentScan.class, SetViaValue.class, spring()))
      .hasValueSatisfying(synth ->
        assertThat(synth).isEqualTo(real));
  }
  ...
  void realAnnotationEqualsSynthesizedAnnotationWithSameValues() {
    ...
    assertThat(DIRECT.find(ComponentScan.class, SetViaValue.class, spring()))
      .hasValueSatisfying(synth -> {
        ...
        // consider them equal.
        assertThat(real).isEqualTo(synth);
      });
  }
  ...
  void synthesizedAnnotationAndRealAnnotationWithSameValuesHaveSameHashCode() {
    ...
    assertThat(DIRECT.find(ComponentScan.class, SetViaValue.class, spring()))
      .hasValueSatisfying(synth ->
        assertThat(synth.hashCode()).isEqualTo(real.hashCode()));
  }
}
